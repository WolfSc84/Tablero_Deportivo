...
#else
  //: BaseDMD(panelsWide, panelsHigh, 9, 6, 7, 8)  -------------> Modificado por Wolf
  : BaseDMD(panelsWide, panelsHigh, 7, 4, 5, 6)
#endif
{
}
...
#else
  //default_pins(pin_noe == 9 && pin_a == 6 && pin_b == 7 && pin_sck == 8),  ---- Modificado por Wolf
  default_pins(pin_noe == 7 && pin_a == 4 && pin_b == 5 && pin_sck == 6),
#endif
  pin_other_cs(-1),
  brightness(255)
{
